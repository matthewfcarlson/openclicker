/**
 AUTOGENERATED ON 2024-06-16 15:50:22.781435
...
export const ProtocolRemoteHeartBeatZ = PresenterMessageBaseZ.extend({
    ...
    min_heap: z.number().int().nonnegative().lte(0xFFFFFFFF), // 32bit unsigned integer 
    free_heap: z.number().int().nonnegative().lte(0xFFFFFFFF), // 32bit unsigned integer 
});
