/**
 AUTOGENERATED ON 2024-06-04 23:45:26.660491
...
extern "C" char* presenter_message_to_json(const uint8_t* message, const uint32_t message_size, char* from_mac, char* to_mac) {
...
extern "C" char* presenter_data_to_json(const uint8_t* message, const uint32_t message_size) {
    if (message[0] == RemoteButtonPressed) {
        PresenterRemoteButtonPressed_t* msg = (PresenterRemoteButtonPressed_t*)message;
