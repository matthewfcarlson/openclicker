/**
 AUTOGENERATED ON 2024-06-07 22:28:25.533950
...
char* EMSCRIPTEN_KEEPALIVE create_RemoteButtonPressed(
    uint8_t* mac_addr,
    uint8_t button_id
) {
...
char* EMSCRIPTEN_KEEPALIVE create_BridgeButtonPressed(
    uint8_t* mac_addr,
    uint8_t button_id
) {
...
char* EMSCRIPTEN_KEEPALIVE create_RemoteHeartBeat(
    uint8_t* mac_addr,
...
char* EMSCRIPTEN_KEEPALIVE create_RemoteRequestState(
    uint8_t* mac_addr,
...
char* EMSCRIPTEN_KEEPALIVE create_PresenterSetStateDarkState(
    uint8_t* mac_addr
) {
...
char* EMSCRIPTEN_KEEPALIVE create_PresenterSetStateMultipleChoiceState(
    uint8_t* mac_addr,
    uint8_t num_choices,
    char* question_text
) {
...
char* EMSCRIPTEN_KEEPALIVE create_PresenterSetStateEmojiState(
    uint8_t* mac_addr,
...
char* EMSCRIPTEN_KEEPALIVE create_PresenterSetState(
    uint8_t* mac_addr,
    char* state_name
) {
...
char* EMSCRIPTEN_KEEPALIVE create_PresenterRemotePacket(
    uint8_t* mac_addr,
    uint8_t* from_mac
) {
